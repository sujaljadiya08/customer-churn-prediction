...
churn_data = pd.read_csv(r"C:\Users\jadiy\OneDrive\Desktop\Sujal\Customer Churn Prediction and Analytics\processed_data.csv")
x = churn_data.drop('Churn', axis=1)
y = churn_data['Churn']
x_train, x_test, y_train, y_test = train_test_split(x, y, test_size=0.2)

loaded_model = pickle.load(open(r"C:\Users\jadiy\OneDrive\Desktop\Sujal\Customer Churn Prediction and Analytics\customer_churn_model.pkl", 'rb'))
